...
import banner from "../../assets/BannerImg.jpeg"; // Make sure the image path is correct

const Banner = () => {
  return (
    <div className="relative w-full h-[600px] sm:h-[500px] md:h-[600px] bg-cover bg-center" style={{ backgroundImage: `url(${banner})` }}>
