    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {meats.map((meat, index) => (
          <div key={index} className="max-w-xs mx-auto rounded-lg overflow-hidden shadow-lg bg-white transform transition duration-300 hover:scale-105">
            <img src={meat.image} alt={meat.name} className="w-full h-48 object-cover"/>
            <div className="p-4">
              ...
              <div className="flex justify-between items-center">
                {/* Shop Now Button */}
                <button className="py-2 px-4 bg-[#1b8057] text-white rounded-lg hover:bg-[#1b8057] transition duration-300 flex items-center text-sm">
                  <FaShoppingBag className="mr-2" />
                  Shop Now
                </button>

                {/* Add to Cart Button */}
                <button className="py-2 px-4 bg-gray-200 text-[#1b8057] rounded-lg hover:bg-gray-300 transition duration-300 flex items-center text-sm">
